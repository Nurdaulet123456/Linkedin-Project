          ...
          <div className="container">
              <div className="sigin__inner">
                <div className="sigin__content">
                    ...
                    <p className='sigin__subtitle'>Stay tuned to your professional network</p>
                </div>
                <form className="form">
                  <div>
                  ...
                  <div className='password'>
                    ...
                    <button className='show__password'>Show</button>
                  </div>

                  <a className='forget__password' href="/">Forget password ?</a>
